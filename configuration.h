...
// SID Mode:
#define DEFAULT_N_MEASUREMENTS ((uint32_t)10 * 25)
#define DEFAULT_SINGLE_MEASURES ((uint32_t)20)
...
#define GPIO_EXT_TRIGGER_OUT        ((unsigned int)4)       /* Physical pin 11, BCM pin 17 */
